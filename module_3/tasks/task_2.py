...
number_first, number_second = int(input("Enter first number: ")), int(input("Enter second number: "))
number_third, number_fourth = int(input("Enter third number: ")), int(input("Enter fourth number: "))
sum_first = number_first + number_second
sum_second = number_third + number_fourth
print("Division = ", sum_first / sum_second)
